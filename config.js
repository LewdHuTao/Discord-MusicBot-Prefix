module.exports = {
	...
	token: process.env.token || "ODkzNjY5MjAzODMwMjU1Njc2.GHmETD.dzwBjtBO2SX2GDKzDaEP7Mmnkyd7p25l4dd6e8", //- Bot's Token
	...
	nodes: [
		{
			...
			password: "e", //- The password of the lavalink server.
			retryAmount: 200, //- The amount of times to retry connecting to the node if connection got dropped.
			retryDelay: 90000, //- Delay between reconnect attempts if connection is lost.
